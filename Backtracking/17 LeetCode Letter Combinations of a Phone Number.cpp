...
public:
    ...
    unordered_map<char,int> TotalCharacters = {{'2',3},{'3',3},{'4',3},{'5',3},{'6',3},{'7',4},{'8',3},{'9',4}};
    vector<string> input, output;
    string str, InputDigits; int Count;

    void backtrack(int digit, int j){
    ...
    vector<string> letterCombinations(string digits) {
		...
		backtrack(0,0);  // backtracking approach
        return output;
    }
};